        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CH_Account_Balance", "AccountType = 1 and Balance >= 0 or AccountType = 0 and Balance >= -500");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CH_BillPay_Period", "Period in ('O','M')");
                    table.CheckConstraint("CH_BillPay_Status", "Status in ('P','S','F','C')");
                    table.ForeignKey(
